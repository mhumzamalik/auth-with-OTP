...
/**
 * Two-panel auth layout matching the design spec exactly.
 *
 * Structure:
 * - Outer background: warm peach (#FAE5D3)
 * - Card: white, rounded-3xl, shadow-xl, two-column (left 60% / right 40%)
 * - Left panel: peach/cream (#F5D5C0), SVG illustration, tagline
 * - Right panel: white, centered form
 * - On mobile: single column, left panel hidden
 */
    ...
    >
      ...
      <div className="w-full max-w-5xl overflow-hidden rounded-3xl shadow-2xl flex flex-col lg:flex-row animate-in fade-in duration-500">
        ...
        >
          ...
          {/* Main illustration — skeleton at laptop SVG matching reference image */}
          <div className="relative z-10 flex flex-col items-center flex-1 justify-center w-full">
            ...
            >
              {/* Inline SVG illustration — skeleton working at a laptop */}
              <svg
                viewBox="0 0 280 280"
                fill="none"
              ...
              >
                ...
                {/* Decorative leaves/plants at base */}
